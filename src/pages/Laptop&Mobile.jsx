...
export function LaptopMobile() {
    let mydata = data.filter((desk) => desk.category === 'Laptop & Mobile Accessories')
        ...
        <>
            ...
            <div className="grid-col">
                <div className='ok'>
                    ...
                    <div>
                        <h2>categories </h2>
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetHead(e.target.checked ? "Mouse" : '')} /><span>Mouse</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => Setmouse(e.target.checked ? "Wireless Charger" : '')} /><span>Wireless Charger</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetLaptop(e.target.checked ? "Earbuds" : '')} /><span> Earbuds</span>
