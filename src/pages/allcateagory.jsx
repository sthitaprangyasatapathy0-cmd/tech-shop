        ...
        <>
            ...
            <div className="grid-col">
                <div className='ok'>
                    ...
                    <div>
                        <h2>categories </h2>
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetHead(e.target.checked ? "Study Essentials" : '')} /><span>Study Essentials</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => Setmouse(e.target.checked ? "Coding Desk Setup" : '')} /><span>Coding Desk Setup</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetLaptop(e.target.checked ? "Laptop & Mobile Accessories" : '')} /><span>Laptop& Mobile Accessories</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetSticker(e.target.checked ? "Stickers & Posters" : '')} /><span>Stickers & Posters</span>
                ...
                <div className='cards'>
                    ...
                    {[...data].sort((a, b) => {
                        ...
                        const categoryMatch =  (head && mydata.category === head) || (mouse && mydata.category === mouse) || (laptop && mydata.category === laptop) || (stickers && mydata.category === stickers) || (!head && !mouse && !laptop && !stickers);
