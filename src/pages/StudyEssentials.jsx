...
export function StudyEssentials() {
    let mydata = data.filter((desk) => desk.category === 'Study Essentials')
        ...
        <>
            ...
            <div className="grid-col">
                <div className='ok'>
                    ...
                    <div>
                        <h2>categories </h2>
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetHead(e.target.checked ? "AlarmClock" : '')} /><span>Alarm Clock</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => Setmouse(e.target.checked ? "Backpack" : '')} /><span>Backpack</span><br />
                        <input className='inputCatagory' type="checkbox" style={{ accentColor: "red" }} onChange={(e) => SetLaptop(e.target.checked ? "Stationery" : '')} /><span> Stationery</span>
